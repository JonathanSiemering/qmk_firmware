...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SEC] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, _______,                             KC_MPLY, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MUTE,
        _______, _______, _______, KC_WBAK, KC_WFWD,          _______,           _______,          _______, _______, _______, _______, _______,
                                            _______, _______, _______,           _______, _______, _______
    ),
