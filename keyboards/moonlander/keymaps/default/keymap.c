...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MOUSE] = LAYOUT_moonlander(
        ...
        KC_VOLU, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,           _______, _______, _______, _______, _______, _______, KC_MPLY,
        KC_VOLD, _______, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, TG(BASE_MAC),
        KC_MPRV, KC_MNXT, _______, KC_BTN1, KC_BTN2,         _______,            _______,          _______, _______, _______, _______, TG(BASE_QUERTY),
